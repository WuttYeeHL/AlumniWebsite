<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RankPage.aspx.cs" Inherits="Rank" %>
    ...
    <form id="Form1" runat="server">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="slide1" style="height: 50px; width: 100%; background-color: white;">
                    <h1 style="padding-top: 2px; margin-left: 100px;">To manage Position type and  allows only English language</h1>
                    <%--<h1 style="padding-top: 2px; margin-left: 100px;">Information and Communication Technology Research Center</h1>
                    <p style="font-family: Black Ops One,cursive; margin-left: 100px;">This form refers to manage Position type and  allows only English language.</p>--%>
        ...
        <div class="row">
            ...
            <div class="col-lg-11 col-md-11 col-sm-11"style="padding-top: 20px; font-family:Black Ops One,cursive;">
                PositionType<asp:TextBox ID="txtPositionType" runat="server" CssClass="bg-danger form-control" Width="200px" Style="margin-left: 18px; display: inline;"></asp:TextBox>
                <br />
                <br />
                ...
                <br />
                <br />
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="PositionID" CssClass= "table table-striped table-bordered table-condensed" Width="70%" CellPadding="4" AllowPaging="True" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PositionID" SortExpression="PositionType">
                            <ItemTemplate>
                                <asp:Label ID="lblPID" runat="server" Text='<%# Bind("PositionID") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="HiddenCol" />
                            <HeaderStyle CssClass="HiddenCol" />
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Position_Type" SortExpression="PositionType" HeaderStyle-CssClass="header-center">
                            <ItemTemplate>
                                <asp:Label ID="lblPositionType" runat="server" Text='<%# Bind("PositionType") %>'></asp:Label>
                            </ItemTemplate>
                             <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                        </asp:TemplateField>
            ...
            <div class="modal-dialog" style="width: 40%; height: 200px;">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <asp:TextBox ID="txtPosition_Type" runat="server" class="form-control" Style="width: 100% !important"></asp:TextBox>
                    </div>
